...
## 🔥🔥🔥 News (Pacific Time)
- 7:40 AM · Apr 02, 2026: [Nano Claude Code: A Minimal Python Reimplementation (~3400 Lines), support open and closed source models, skill and memory](https://github.com/SafeRL-Lab/nano-claude-code)
